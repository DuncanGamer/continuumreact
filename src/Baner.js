        ...
        <>
            <div class=" py-32">
                <div class="container w-full flex items-center mx-auto bg-do-blue-dark text-white py-32 px-16 "
                    ...
                    <div class="mt-56 md:w-1/2">
                        <button
                            class=" px-5 py-3 md:py-3 rounded-xl hover:shadow-md shadow-lg shadow-blue-700/60 bg-blue-700 hover:bg-blue-700 active:bg-blue-900 text-white font-bold transition duration-300 ease-out hover:ease-in">Create
                            your account</button>
                    </div>
                </div>
            </div>
                ...
                <div class="grid md:grid-cols-3 gap-6 lg:gap-12 text-center">
                    <div class="mb-12 md:mb-0">
                        ...
                        <ul class="flex justify-center mb-0">
                            <li>
                                <svg data-icon="star" class="w-4 text-yellow-500" viewBox="0 0 576 512">
                                    <path fill="currentColor"
